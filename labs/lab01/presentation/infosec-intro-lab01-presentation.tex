...
\item
  \href{mailto:1132242906@rudn.ru}{\nolinkurl{1132242906@rudn.ru}}
\item
  \url{https://github.com/Soiroys/2025-2026-infosec}
\end{itemize}
\end{column}

\begin{column}{0.3\linewidth}
\pandocbounded{\includegraphics[keepaspectratio]{./image/os.jpg}}
\end{column}
\end{columns}
\end{frame}
