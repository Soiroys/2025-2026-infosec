...
\caption{Настройка виртуального оборудования}

\end{figure}%

После настройки, запускаем виртуальную машину, выбираем загруузочный
диск, задаем параметры установки.
...
\caption{Задание параметров установки}

\end{figure}%

Нажимаем \enquote{Готово} и ждем окончания загрузки. Затем входим в
систему
...
\caption{Первоначальный вход в систему}
...
\caption{Просмотр параметров виртуальной машины}
